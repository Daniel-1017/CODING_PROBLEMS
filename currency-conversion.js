...
const isVowel = l => "aeiou".includes(l.toLowerCase());

const convertMyDollars = (usd, currency) => {
  const convertedUSD =
    usd * parseInt(CONVERSION_RATES[currency], isVowel(currency[0]) ? 10 : 2);
  return `You now have ${convertedUSD} of ${currency}.`;
};
